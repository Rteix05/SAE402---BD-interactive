...
const cloudRevealVariants: Variants = {
  initial: (i: number) => ({
    opacity: 0,
    scale: 2.5,
    x: "-50%",
...
const cloudDriftVariants: Variants = {
  animate: (i: number) => ({
    x: ["-20vw", "120vw"],
    transition: {
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section
        id="guide"
        className="relative w-full min-h-screen bg-black flex flex-col items-center justify-center p-8 md:p-24 border-t-4 border-red-600"
      >
        <motion.div
          ...
          <div className="max-w-3xl mx-auto mb-16 space-y-8">
            ...
            >
              ...
              <p className="text-gray-200 text-xl md:text-2xl uppercase tracking-widest font-sans leading-tight">
                Le sens de lecture est de{" "}
                <span className="text-white font-bold">droite à gauche</span>.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-200 text-xl md:text-2xl uppercase tracking-widest font-sans leading-tight">
                Cliquez sur les{" "}
                <span className="text-white font-bold">flèches aux bords</span>{" "}
                de l'écran pour tourner les pages.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white text-xl md:text-2xl uppercase tracking-widest font-sans leading-tight italic">
                ...
                Utilisez votre <span className="font-bold">clavier</span> pour
            ...
            <div className="text-gray-400 text-sm uppercase tracking-wider font-sans space-y-1">
              <p>
                ...
                <span className="text-gray-100">
                  LOU CALMES - MARWAN BOUCHEBBAT
                </span>
              </p>
              <p>
                Développement :{" "}
                <span className="text-gray-100">
                  RAFAEL TEXIERA - OURIRI RADOUAN
                </span>
              </p>
              <p className="pt-2 opacity-50 text-xs">
